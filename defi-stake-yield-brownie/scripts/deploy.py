...
def deploy_token_farm_and_dapp_token(copy_folders_to_front_end=False):
    account = get_account()
...
def copy_folders_to_front_end(src:str, dest:str):
    if os.path.exists(dest):
       shutil.rmtree(dest)
    shutil.copytree(src, dest)

def main():
    deploy_token_farm_and_dapp_token(copy_folders_to_front_end=True)
